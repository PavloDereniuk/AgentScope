...
**Cluster E total:** ~8 днів, 12 micro-releases (v0.4.3 → v0.5.9). **E.1 + E.2 — must-have для M3 на free-tier; E.7 — deploy-safety; E.11 — єдиний пункт з необмеженим збитком при відмові; E.12 і E.13 — наслідки інцидентів 2026-07-31 і 2026-07-30/08-11.**
...
| v0.5.9 | 2026-08-22 | E.13 (ingestion heartbeat + edge-triggered uptime alert) | 🟡 закомічено, тег не виставлено |
| … | … | … | … |
