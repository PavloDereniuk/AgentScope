...
- **⚠️ 2026-09-22, пізніше того ж дня:** власник повідомив, що **другий транш гранту вже виплачено**. Грантові дедлайни більше не є фактором пріоритезації — «grant-driven / deadline-driven» позначки в Cluster G, E.11 і Phase 2.5 читати як історичний контекст. Далі обирати за продуктовою цінністю: E.11 лишається (ризик без стелі не залежить від гранту), G.2/G.3 — за потреби.
